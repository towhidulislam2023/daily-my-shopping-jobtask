...
const Table = () => {
  return (
    <div className="my-4  overflow-x-auto w-[300px] lg:w-full mx-auto">
      <div className="inline-block min-w-full overflow-x-auto">
        <table className="min-w-full overflow-x-auto divide-y-2 border border-gray-300 divide-gray-200 bg-white text-lg">
          <thead className="bg-gray-300">
            <tr>
              <th className=" text-left px-4 py-2 font-medium text-gray-900">
                Table Title
              </th>
              <th className=" text-left border-l-4 border-white  px-4 py-2 font-medium text-gray-900">
                Table Title
              </th>
              <th className="text-left border-l-4 border-white px-4 py-2 font-medium text-gray-900">
                Table Title
          ...
          <tbody className="divide-y divide-gray-200">
            <tr className="odd:bg-gray-50 border-b border-gray-400">
              <td className="whitespace-nowrap px-4 py-2 font-medium text-gray-900">
                Lorem ipsum dolor sit amet.
              </td>
              <td className="whitespace-nowrap border-l-4 border-white px-4 py-2 text-gray-700">
                Lorem ipsum dolor sit amet.
              </td>
              <td className="whitespace-nowrap border-l-4 border-white px-4 py-2 text-gray-700">
                Lorem ipsum dolor sit amet.
              </td>
              <td className="whitespace-nowrap border-l-4 border-white px-4 py-2 text-gray-700 flex gap-4 items-center">
                <div className="h-[24px] w-[55px] bg-blue-600 flex items-center justify-center text-white p-3">
                  <span>
                    <svg
                ...
                <div className="h-[24px] w-[95px] bg-amber-500 flex items-center justify-center text-white p-3">
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
